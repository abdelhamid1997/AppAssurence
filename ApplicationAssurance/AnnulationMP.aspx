<%@ Page Title="" Language="C#" MasterPageFile="~/Avenant.Master" AutoEventWireup="true" CodeBehind="AnnulationMP.aspx.cs" Inherits="Avenent.AnnulationMP" %>
...
<asp:Button ID="Button1" CssClass="btn-primary btnSearch" runat="server" Text="Rechercher" OnClick="Button1_Click" />
    ...
    <asp:Label ID="Label1" CssClass="lblTitle" runat="server" Text="Annulation"></asp:Label>
   </div>
</div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" CssClass="GridViewAv" runat="server" AllowPaging="True" EnableSortingAndPagingCallbacks="True" PageSize="6">
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="id_affaire" DataNavigateUrlFormatString="~/AffectationAnnulation.aspx?id_affaire={0}" DataTextField="id_affaire" HeaderText="Action" NavigateUrl="~/AffectationAnnulation.aspx" Target="_blank" />
        </Columns>
</asp:GridView>
        </div>
</asp:Content>