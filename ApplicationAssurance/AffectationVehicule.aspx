<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AffectationVehicule.aspx.cs" Inherits="ApplicationAssurance.AffectationVehicule" %>
                       ...
                       <div class="modal-body">
                         ...
                         <label>Souscripteur</label>         
                          ...
                          <asp:TextBox ID="numattestxt" runat="server"></asp:TextBox>
                           ...
                           <div class="form-group">
                         <label id="Immatriculationlbl" runat="server">Immatraculation</label>
                        <asp:TextBox ID="textImmatriculation" runat="server" TextMode="DateTime" ></asp:TextBox>
                               </div>
                        <div class="form-group">
                        <label id="Marquelbl" runat="server">Marque</label>
                        <asp:TextBox ID="textMarque" runat="server"></asp:TextBox>
                            </div>
                        <div class="form-group">
                        <label id="Usagelbl" runat="server">Usage</label>
                        <asp:TextBox ID="textUsage" runat="server"></asp:TextBox>                           
                         </div>  
                           <div class="form-group">
                        <label id="DateMeclbl" runat="server">Date MEC</label>
                        <asp:TextBox ID="textDateMec" runat="server"></asp:TextBox>                           
                          </div>
                      </div> 
