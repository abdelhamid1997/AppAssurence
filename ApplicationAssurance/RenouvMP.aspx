<%@ Page Title="" Language="C#" MasterPageFile="~/Avenant.Master" AutoEventWireup="true" CodeBehind="RenouvMP.aspx.cs" Inherits="Avenent.WebForm1" %>
...
<asp:Button ID="Button1" CssClass="btn-primary btnSearch" runat="server" Text="Rechercher" OnClick="Button1_Click" />
    ...
    <asp:Label ID="Label1" CssClass="lblTitle" runat="server" Text="Renouvellement"></asp:Label>
   </div>
</div>
</asp:Content>
