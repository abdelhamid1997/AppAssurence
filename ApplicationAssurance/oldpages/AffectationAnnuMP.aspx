<%@ Page Title="" Language="C#" MasterPageFile="~/Avenant.Master" AutoEventWireup="true" CodeBehind="AffectationAnnuMP.aspx.cs" Inherits="Avenent.AffectationAnnuMP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:Label ID="Label1" runat="server" Text="Annulation"></asp:Label>
</asp:Content>
    ...
    <table border="1" class="auto-style1" >
          ...
          <tr>
           ...
           <tr>
            ...
            <td> 
                <asp:TextBox ID="datedebuttxt" runat="server" TextMode="DateTimeLocal"></asp:TextBox>
            </td>
        </tr>
           <tr>
            <td class="auto-style2">
            ...
            <td> 
                <asp:TextBox ID="datefintxt" runat="server" TextMode="Date"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style3">
