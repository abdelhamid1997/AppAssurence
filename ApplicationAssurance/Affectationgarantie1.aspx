<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Affectationgarantie1.aspx.cs" Inherits="ApplicationAssurance.Affectationgarantie1" %>
            ...
            <div class="form-control">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label>idaff</label>
                        <asp:TextBox ID="idafftext" runat="server" Text="0"></asp:TextBox>
                           </div>
                    </div>
                    <div class="modal-footer">
