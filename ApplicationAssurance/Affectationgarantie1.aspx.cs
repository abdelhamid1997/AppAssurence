    ...
    public partial class Affectationgarantie1 : System.Web.UI.Page
    {
        ...
        protected void ButtonEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            else if (Session["SelecteValue"].ToString() == "Auto" && NumAtt() == 1)
            {
                ...
                SqlCommand cmd = new SqlCommand("update montant set montant='"+montanttxt.Text+ "',primenette='"+primenettxt.Text+ "',taxeTVA='"+tvatxt.Text+ "',taxeEvRc='"+taxeevrctxt.Text+ "',taxeEvGa='"+taxeevga.Text+ "',accessoire='"+accessoiretxt.Text+ "',taxe1='"+taxe1txt.Text+"',taxe2='"+taxe2txt.Text+ "' where idAff='"+idafftext.Text+"'", cnx);
                cmd.ExecuteNonQuery();
