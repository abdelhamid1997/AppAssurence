...
{
    public partial class AffectationResiliation1 : System.Web.UI.Page
    {
        ADO d = new ADO();
        ...
        public string AddMoney()
        {
            ...
            if (d.dr.Read())
            {
                ...
                d.cmd.Parameters.Add("@Net_A_Payer", SqlDbType.Decimal).Value = decimal.Parse(netapayertxt.Text);
