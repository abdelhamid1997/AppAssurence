...
namespace ApplicationAssurance
{
    public partial class SaisieAff : System.Web.UI.Page
    {
        ...
        public int GsmValidation()
        {
            ...
            {
                //labregularGSM.ForeColor = Color.Green;
                //labregularGSM.Text = "synthaxe correcte";
                nb = 1;

            }
            else
            {
                //labregularGSM.ForeColor = Color.Red;
                // labregularGSM.Text = " synthaxe incorrecte!!!";
                nb = 0;
            }
            return nb;
        }
        ...
        public int emailValidation()
        {
            ...
            {
                //LabRequiredEmail.ForeColor = Color.Green;
                //LabRequiredEmail.Text = "synthaxe correcte";
                nbEmail = 1;
            }
            else
            {
                //LabRequiredEmail.ForeColor = Color.Red;
                //LabRequiredEmail.Text = " synthaxe incorrecte!!!";
                nbEmail = 0;
            }
            return nbEmail;
        }
        ...
        public int NumPermisValidation()
        {
            ...
            {
                //labrequiredNumPermis.ForeColor = Color.Green;
                //labrequiredNumPermis.Text = "synthaxe correcte";
                nbpermi = 1;
            }
            else
            {
                //labrequiredNumPermis.ForeColor = Color.Red;
                //labrequiredNumPermis.Text = " synthaxe incorrecte!!!";
                nbpermi = 0;
            }
            return nbpermi;
        }
        ...
        public int ImmatriculationValidation()
        {
            ...
            {
                //labrequiredImmatriculation.ForeColor = Color.Green;
                //labrequiredImmatriculation.Text = "synthaxe correcte";
                nbImma = 1;
            }
            else
            {
                //labrequiredImmatriculation.ForeColor = Color.Red;
                //labrequiredImmatriculation.Text = " synthaxe incorrecte!!!";
                nbImma = 0;
            }
            return nbImma;
        }
        ...
        protected void btnValider_Click(object sender, EventArgs e)
        {
            int flt;
                ...
                if (DropDownListChoix.SelectedValue == "Auto")
                {
                    ...
                    if (NumAtt() == 0 && NumPermis() == 0 && NumPermisValidation() == 1 && ImmatriculationValidation() == 1 && TextBoxMontant.Text != "0" && TextBoxMontant.Text != "")
                    {
                        try
                        {
                            InsertClientAff();
                            ...
                            {
                                d.cmd.CommandText = "insert  into conducteur values('" + TextBoxId.Text + "','" + TextBoxNomRS.Text + "','" + TextBoxPrenomFJ.Text + "','" + TextBoxNumP.Text + "')";
                                d.cmd.Connection = d.con;
                                d.cmd.ExecuteNonQuery();
                            }
                            else
                            {
                                d.cmd.CommandText = "insert  into conducteur values('" + TextBoxId.Text + "','" + TextBoxNomConduct.Text + "','" + TextBoxPrenomConduct.Text + "','" + TextBoxNumP.Text + "')";
                                d.cmd.Connection = d.con;
                                d.cmd.ExecuteNonQuery();
                            }
                              AddMoney();  
