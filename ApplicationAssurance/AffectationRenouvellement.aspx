<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AffectationRenouvellement.aspx.cs" Inherits="ApplicationAssurance.AffectationRenouvellement" %>
            ...
            <div class="form-control">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:TextBox ID="primenettxt" Text="0" runat="server"></asp:TextBox>
                           </div>
                           <div class="form-group">
                        <label>TVA</label>
                        <asp:TextBox ID="tvatxt" Text="0" runat="server"></asp:TextBox>
                            </div>         
                           <div class="form-group">
                        <label>taxeEvrc</label>
                        <asp:TextBox ID="taxeevrctxt" Text="0" runat="server"></asp:TextBox>
                           </div>
                           <div class="form-group">
                        <label>TaxeEvga</label>
                        <asp:TextBox ID="taxeevga" Text="0" runat="server"></asp:TextBox>
                         
                           </div>
                           <div class="form-group">
                        <label>Accessoire</label>
                        <asp:TextBox ID="accessoiretxt" Text="0" runat="server"></asp:TextBox>
                           </div>
                 
                           <div class="form-group">
                        <label>taxe1</label>
                        <asp:TextBox ID="taxe1txt" Text="0" runat="server"></asp:TextBox>
                           </div>

                         <div class="form-group">
                        <label>taxe2</label>
                        <asp:TextBox ID="taxe2txt" Text="0" runat="server"></asp:TextBox>
                          </div>

                           <div class="form-group">
                        <label>montant</label>
                        <asp:TextBox ID="montanttxt" Text="0" runat="server"></asp:TextBox>
                           </div>
                    </div>
                    <div class="modal-footer">
